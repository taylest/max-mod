...
# direct methods
.method public constructor <init>(IILg38;)V
    .locals 1
    ...
    iput-object p1, p0, Lif4;->n0:Lg38;
...
.method public final F(Ly64;)J
    ...
    iput-wide v12, v1, Lif4;->t0:J

    iput-wide v12, v1, Lif4;->s0:J

    invoke-virtual {v1}, Ldj0;->d()V
    ...
    iget-object v3, v0, Ly64;->a:Landroid/net/Uri;
    ...
    :goto_0
    iget-object v11, v0, Ly64;->e:Ljava/util/Map;

    const/4 v10, 0x1

    invoke-virtual/range {v1 .. v11}, Lif4;->h(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;

    move-result-object v2

    iget-wide v3, v0, Ly64;->f:J

    iget-wide v5, v0, Ly64;->g:J

    iput-object v2, v1, Lif4;->o0:Ljava/net/HttpURLConnection;

    invoke-virtual {v2}, Ljava/net/HttpURLConnection;->getResponseCode()I

    move-result v7

    iput v7, v1, Lif4;->r0:I

    invoke-virtual {v2}, Ljava/net/HttpURLConnection;->getResponseMessage()Ljava/lang/String;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_5

    iget v7, v1, Lif4;->r0:I
    ...
    sget-object v8, Lru6;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {v9}, Lye2;->t(Ljava/lang/String;)V
    ...
    sget-object v11, Lru6;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {v5}, Lye2;->t(Ljava/lang/String;)V
    ...
    iput-object v2, v1, Lif4;->p0:Ljava/io/InputStream;

    if-eqz v7, :cond_a

    new-instance v2, Ljava/util/zip/GZIPInputStream;

    iget-object v6, v1, Lif4;->p0:Ljava/io/InputStream;
    ...
    :cond_a
    :goto_7
    iput-boolean v14, v1, Lif4;->q0:Z

    invoke-virtual/range {p0 .. p1}, Ldj0;->f(Ly64;)V

    :try_start_4
    invoke-virtual {v1, v3, v4}, Lif4;->j(J)V
    :try_end_4
    .catch Ljava/io/IOException; {:try_start_4 .. :try_end_4} :catch_3

    iget-wide v0, v1, Lif4;->s0:J
    ...
    sget-object v9, Lru6;->a:Ljava/util/regex/Pattern;
    ...
    :cond_d
    sget-object v9, Lru6;->b:Ljava/util/regex/Pattern;
...
.method public final close()V
    ...
    :try_start_0
    iget-object v2, p0, Lif4;->p0:Ljava/io/InputStream;

    if-eqz v2, :cond_1

    iget-wide v3, p0, Lif4;->s0:J
    ...
    :cond_0
    iget-wide v5, p0, Lif4;->t0:J

    sub-long v5, v3, v5

    :goto_0
    iget-object v3, p0, Lif4;->o0:Ljava/net/HttpURLConnection;

    invoke-static {v3, v5, v6}, Lif4;->i(Ljava/net/HttpURLConnection;J)V
    :try_end_0
    ...
    :cond_1
    :goto_1
    iput-object v1, p0, Lif4;->p0:Ljava/io/InputStream;

    invoke-virtual {p0}, Lif4;->g()V

    iget-boolean v1, p0, Lif4;->q0:Z

    if-eqz v1, :cond_2

    iput-boolean v0, p0, Lif4;->q0:Z
...
.method public final g()V
    ...
    iget-object v0, p0, Lif4;->o0:Ljava/net/HttpURLConnection;
    ...
    iput-object v0, p0, Lif4;->o0:Ljava/net/HttpURLConnection;
...
.method public final getUri()Landroid/net/Uri;
    ...
    iget-object p0, p0, Lif4;->o0:Ljava/net/HttpURLConnection;
...
.method public final h(Ljava/net/URL;I[BJJZZLjava/util/Map;)Ljava/net/HttpURLConnection;
    ...
    iget-object v1, p0, Lif4;->Z:Lg38;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lg38;->z()Ljava/util/Map;
    ...
    :cond_0
    iget-object p0, p0, Lif4;->n0:Lg38;

    invoke-virtual {p0}, Lg38;->z()Ljava/util/Map;
    ...
    :cond_1
    sget-object p0, Lru6;->a:Ljava/util/regex/Pattern;
    ...
    invoke-static {p4, p5, p0, p10}, Lew1;->l(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final j(J)V
    ...
    iget-object v5, p0, Lif4;->p0:Ljava/io/InputStream;
    ...
    invoke-virtual {p0, v4}, Ldj0;->a(I)V
...
.method public final read([BII)I
    ...
    :cond_2
    iget-object v0, p0, Lif4;->p0:Ljava/io/InputStream;
    ...
    :cond_3
    iget-wide p2, p0, Lif4;->t0:J

    int-to-long v0, p1

    add-long/2addr p2, v0

    iput-wide p2, p0, Lif4;->t0:J
