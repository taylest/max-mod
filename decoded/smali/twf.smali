...
.method public static b(Landroid/view/View;Lokg;Landroid/graphics/Rect;)Lokg;
    .locals 1
...
.method public static j(Landroid/view/View;)Lokg;
    .locals 7

    sget-boolean v0, Lckg;->d:Z
    ...
    :try_start_0
    sget-object v2, Lckg;->a:Ljava/lang/reflect/Field;
    ...
    sget-object v2, Lckg;->b:Ljava/lang/reflect/Field;
    ...
    sget-object v3, Lckg;->c:Ljava/lang/reflect/Field;
    ...
    invoke-static {v4, v5, v6, v2}, Ld67;->b(IIII)Ld67;

    move-result-object v2

    invoke-virtual {v3, v2}, Ldkg;->i(Ld67;)V
    ...
    invoke-static {v2, v4, v5, v0}, Ld67;->b(IIII)Ld67;

    move-result-object v0

    invoke-virtual {v3, v0}, Ldkg;->f(Ld67;)V

    invoke-virtual {v3}, Ldkg;->b()Lokg;

    move-result-object v0

    iget-object v2, v0, Lokg;->a:Lmkg;

    invoke-virtual {v2, v0}, Lmkg;->q(Lokg;)V
    ...
    invoke-virtual {v2, p0}, Lmkg;->d(Landroid/view/View;)V
    :try_end_0
...
.method public static u(Landroid/view/View;Lw4a;)V
    .locals 2
    ...
    invoke-direct {v0, p0, p1}, Lswf;-><init>(Landroid/view/View;Lw4a;)V
