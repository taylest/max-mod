...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Lykc;
...
.method public final a(Ldlg;Z)V
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Lykc;

    invoke-virtual {v0, p1}, Lykc;->j(Ldlg;)Lv3e;
...
.method public final onCreate()V
    ...
    invoke-virtual {p0, v0, v1}, Las3;->k0(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final onStartJob(Landroid/app/job/JobParameters;)Z
    ...
    invoke-virtual {p0, p1, v0}, Las3;->v(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, v0}, Las3;->p(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v4, v0}, Las3;->p(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lwle;->b(Landroid/app/job/JobParameters;)[Landroid/net/Uri;
    ...
    :cond_3
    invoke-static {p1}, Lwle;->a(Landroid/app/job/JobParameters;)[Ljava/lang/String;
    ...
    :cond_4
    invoke-static {p1}, Lxle;->a(Landroid/app/job/JobParameters;)Landroid/net/Network;

    move-result-object p1

    iput-object p1, v0, Lefb;->c:Ljava/lang/Object;

    iget-object p1, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lklg;

    iget-object p0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Lykc;

    invoke-virtual {p0, v2}, Lykc;->n(Ldlg;)Lv3e;

    move-result-object p0

    invoke-virtual {p1, p0, v0}, Lklg;->h(Lv3e;Lefb;)V
...
.method public final onStopJob(Landroid/app/job/JobParameters;)Z
    ...
    invoke-virtual {p0, p1, v1}, Las3;->v(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:Lykc;

    invoke-virtual {v2, p1}, Lykc;->j(Ldlg;)Lv3e;
    ...
    iget-object v4, v3, Lklg;->d:Lqo8;

    new-instance v5, Lfce;

    invoke-direct {v5, v3, v2, v0}, Lfce;-><init>(Lklg;Lv3e;Z)V

    invoke-interface {v4, v5}, Lhre;->c(Ljava/lang/Runnable;)V

    :cond_2
    iget-object p0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:Lklg;

    iget-object p0, p0, Lklg;->f:Lbcb;
    ...
    :try_start_1
    iget-object p0, p0, Lbcb;->p0:Ljava/util/HashSet;
