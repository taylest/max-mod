...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lsze;-><init>(Lbzf;)V

    iput-object v0, p0, Lbzf;->f:Lsze;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lbzf;->a:Ljava/util/ArrayList;
...
.method public final b()V
    ...
    invoke-virtual {v1, v2, v3}, Lazf;->c(J)V

    :cond_2
    iget-object v2, p0, Lbzf;->c:Landroid/view/animation/Interpolator;

    if-eqz v2, :cond_3

    iget-object v3, v1, Lazf;->a:Ljava/lang/ref/WeakReference;
    ...
    :cond_3
    iget-object v2, p0, Lbzf;->d:Lczf;

    if-eqz v2, :cond_4

    iget-object v2, p0, Lbzf;->f:Lsze;
