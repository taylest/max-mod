...
.method public constructor <init>(Ljava/util/Set;)V
    ...
    iput-object p1, p0, Lq46;->a:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lq46;->a:Ljava/util/ArrayList;
...
.method public final a(Lhcb;Ljava/lang/String;Ljava/util/Map;)V
    ...
    iget-object p0, p0, Lq46;->a:Ljava/util/ArrayList;
    ...
    :try_start_0
    invoke-interface {v0, p1, p2, p3}, Lkcb;->a(Lhcb;Ljava/lang/String;Ljava/util/Map;)V
    :try_end_0
    ...
    invoke-static {v1, v2, v0}, Ltd5;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final b(Lufd;)V
    ...
    :try_start_0
    invoke-interface {v0, p1}, Lclc;->b(Lufd;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final c(Lhcb;)V
    ...
    :try_start_0
    invoke-interface {v0, p1}, Lkcb;->c(Lhcb;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final d(Lhcb;Ljava/lang/String;Ljava/lang/Throwable;Ljava/util/Map;)V
    ...
    :try_start_0
    invoke-interface {v0, p1, p2, p3, p4}, Lkcb;->d(Lhcb;Ljava/lang/String;Ljava/lang/Throwable;Ljava/util/Map;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final e(Lhcb;Ljava/lang/String;Z)V
    ...
    :try_start_0
    invoke-interface {v0, p1, p2, p3}, Lkcb;->e(Lhcb;Ljava/lang/String;Z)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final f(Lhcb;Ljava/lang/Throwable;)V
    ...
    :try_start_0
    invoke-interface {v0, p1, p2}, Lclc;->f(Lhcb;Ljava/lang/Throwable;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final g(Lhcb;)V
    ...
    :try_start_0
    invoke-interface {v0, p1}, Lclc;->g(Lhcb;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final h(Lhcb;)V
    ...
    :try_start_0
    invoke-interface {v0, p1}, Lclc;->h(Lhcb;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final i(Lhcb;Ljava/lang/String;)Z
    ...
    invoke-interface {v0, p1, p2}, Lkcb;->i(Lhcb;Ljava/lang/String;)Z
...
.method public final j(Lhcb;Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-interface {v0, p1, p2}, Lkcb;->j(Lhcb;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final k(Lhcb;Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-interface {v0, p1, p2}, Lkcb;->k(Lhcb;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
