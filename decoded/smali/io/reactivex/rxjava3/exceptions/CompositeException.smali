...
.method public static a(Lpwe;Ljava/lang/Throwable;Ljava/lang/String;)V
    .locals 5

    invoke-virtual {p0, p2}, Lpwe;->c(Ljava/io/Serializable;)Lpwe;

    move-result-object p2

    invoke-virtual {p2, p1}, Lpwe;->c(Ljava/io/Serializable;)Lpwe;
    ...
    invoke-virtual {p2, v0}, Lpwe;->c(Ljava/io/Serializable;)Lpwe;
    ...
    invoke-virtual {p0, v4}, Lpwe;->c(Ljava/io/Serializable;)Lpwe;

    move-result-object v4

    invoke-virtual {v4, v3}, Lpwe;->c(Ljava/io/Serializable;)Lpwe;

    move-result-object v3

    invoke-virtual {v3, v0}, Lpwe;->c(Ljava/io/Serializable;)Lpwe;
    ...
    invoke-static {p0, p1, p2}, Lio/reactivex/rxjava3/exceptions/CompositeException;->a(Lpwe;Ljava/lang/Throwable;Ljava/lang/String;)V
...
.method public final b(Lpwe;)V
    ...
    invoke-virtual {p1, p0}, Lpwe;->c(Ljava/io/Serializable;)Lpwe;

    move-result-object v0

    const-string v1, "\n"

    invoke-virtual {v0, v1}, Lpwe;->c(Ljava/io/Serializable;)Lpwe;
    ...
    invoke-virtual {p1, v5}, Lpwe;->c(Ljava/io/Serializable;)Lpwe;

    move-result-object v5

    invoke-virtual {v5, v4}, Lpwe;->c(Ljava/io/Serializable;)Lpwe;

    move-result-object v4

    invoke-virtual {v4, v1}, Lpwe;->c(Ljava/io/Serializable;)Lpwe;
    ...
    invoke-virtual {p1, v4}, Lpwe;->c(Ljava/io/Serializable;)Lpwe;
    ...
    invoke-virtual {v4, v5}, Lpwe;->c(Ljava/io/Serializable;)Lpwe;
    ...
    invoke-static {p1, v3, v4}, Lio/reactivex/rxjava3/exceptions/CompositeException;->a(Lpwe;Ljava/lang/Throwable;Ljava/lang/String;)V
    ...
    :cond_1
    invoke-virtual {p1, v1}, Lpwe;->c(Ljava/io/Serializable;)Lpwe;
...
.method public final declared-synchronized getCause()Ljava/lang/Throwable;
    ...
    invoke-direct {v0, v1, v2}, Lqd3;-><init>(Ljava/lang/String;I)V
...
.method public final printStackTrace(Ljava/io/PrintStream;)V
    ...
    invoke-direct {v0, v1, p1}, Lrd3;-><init>(ILjava/lang/Object;)V

    invoke-virtual {p0, v0}, Lio/reactivex/rxjava3/exceptions/CompositeException;->b(Lpwe;)V
