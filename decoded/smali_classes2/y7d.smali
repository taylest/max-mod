...
# direct methods
.method public constructor <init>(Lflc;Ljava/util/concurrent/ExecutorService;)V
    .locals 0

    invoke-direct {p0, p2}, Ljtd;-><init>(Ljava/util/concurrent/Executor;)V

    iput-object p1, p0, Ly7d;->X:Lflc;

    iput-object p2, p0, Ly7d;->Y:Ljava/util/concurrent/ExecutorService;
...
.method public final H(Lbud;I)V
    ...
    invoke-virtual {p1, p0}, Lx7d;->F(Lac6;)V
...
.method public final t(Landroid/view/ViewGroup;I)Lphc;
    ...
    iget-object p0, p0, Ly7d;->X:Lflc;

    invoke-direct {p1, p0, p2, v0, v1}, Lx7d;-><init>(Lflc;Lone/me/sdk/uikit/common/views/OneMeDraweeView;Landroidx/appcompat/widget/AppCompatTextView;Landroid/widget/LinearLayout;)V
